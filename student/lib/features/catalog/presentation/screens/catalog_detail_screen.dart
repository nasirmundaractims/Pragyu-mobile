...
/// S-29 Catalog detail — listing summary (purchase stays on web for now).
    ...
    return ListView(
      ...
      children: [
        ...
        Container(
          ...
          child: const Text(
            'Enrollment and checkout stay on the Pragyu web portal for now. '
            'Use Browse catalog to discover courses, then continue purchase on web.',
